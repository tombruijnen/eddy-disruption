...
% 'legendName' - add legend name to object and create legend.
%
%
% Outputs
...
%
% 02-10-2017: S.E. Zijlema
% Added support for legend with property 'legendName'
...
params.addParameter('legendName', '', @(x) ischar(x) | iscell(x));
...
legendName =  params.Results.legendName;
...
%Show legend if entries are specified
if ~isempty(legendName)
    H.mainLine.DisplayName=legendName;
