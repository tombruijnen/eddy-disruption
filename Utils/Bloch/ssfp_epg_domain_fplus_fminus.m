...
RF_phase_mode =  1;  %  0 = All RF pulses have the same phase phi=0deg, i.e., rotation around x-axis
...
RF_phase_inc  = 117;  % Used linear RF phase increment ONLY if RF_phase_mode = +1  ;  A useful value is 50deg
